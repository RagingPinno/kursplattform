...
function CourseDetail({ user, onCourseUpdate }) {
                ...
                <div className="bg-gray-50 rounded-lg p-6 sticky top-28">
                  ...
                  {user ? (
                    ...
                    <div className="text-center p-4 border-2 border-dashed rounded-lg">
                        ...
                        <button onClick={redirectToLogin} className="mt-3 inline-block bg-indigo-600 text-white font-bold py-2 px-4 rounded-lg hover:bg-indigo-700 transition-colors">
                            Logga in
                        </button>
                    </div>
                  )}
