...
function MyCourses() {
  ...
  return (
    // ✅ KORRIGERING: Lade till klasser för att centrera och begränsa bredden
    <main className="container mx-auto px-4 py-8 max-w-7xl">
      <header className="relative mb-10">
        <div>
          <h1 className="text-4xl font-bold text-gray-800">Min resa</h1>
          <p className="text-gray-500 mt-1">Din personliga översikt av pågående och avslutade kurser.</p>
        </div>
